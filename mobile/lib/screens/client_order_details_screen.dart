...
class _ClientOrderDetailsScreenState extends State<ClientOrderDetailsScreen> {
  ...
  void _showWebAwareMessage(
    ...
    if (!mounted) return;
    PlatformFeedback.show(context, message, error: error, success: success);
  }
  ...
  Widget build(BuildContext context) {
    try {
      ...
      debugPrint('ClientOrderDetails build error: $e');
      debugPrint('$st');
      return Directionality(
        textDirection: TextDirection.rtl,
        child: Scaffold(
          ...
          body: const Center(
            child: Padding(
              ...
              child: Text(
                'تعذر عرض تفاصيل الطلب حالياً. حاول التحديث أو العودة ثم الدخول مرة أخرى.',
